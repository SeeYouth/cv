      ...
      <div className="text">
        <ul>
          <div className="subtitle">
            ...
            <h2>
              <span>2020 - À aujourd'hui</span>formation en autodidacte
            </h2>
          </div>
        ...
        <ul>
          <div className="subtitle">
            <div className="icon-subtitle"></div>
            <h2>
              <span>avril-octobre 2020</span>openclassrooms
            </h2>
          </div>
        ...
        <ul>
          <div className="subtitle">
            <div className="icon-subtitle"></div>
            <h2>
              <span>2002 - 2004</span>cap maintenance de matériel bureautique
            </h2>
          </div>
